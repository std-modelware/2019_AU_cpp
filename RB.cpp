...
public:
	Guest(int size = 1) {
		...
		this->size = size;
		this->name = ++s_quanity;
		//cout << "constr " << this->size << " " << this->name << endl;
	};

	//Guest(const Guest& p) {
	//	this->size = p.size;
	//	this->name = p.name;		
	//	//cout << "constr  copy " << this->size << " " << this->name << endl;
	//	//cout << "constr  copy " << p.size << " " << p.name << endl;

	//}

	//Guest& operator=(Guest other)
	//{
	//	cout << "constr  assign" << this->size << " " << this->name << endl;
	//	cout << "constr  assign" << other.size << " " << other.name << endl;
...
public:
	...
	bool onArrive(Guest& g) {
		...
		if (p == false) { 
			...
			cout << "group " << g.getName() << " is in the queue" << endl;
 return false;
		};
	...
	void printInfo() {
		cout << endl  << endl << ">>>>INFO" <<endl << ">TABLES" << endl << "maximum Size = " << maxSize << endl;
		...
		cout << "There were " << quanity << " guests today yet." << endl << "<<<<INFO ENDED" << endl;
